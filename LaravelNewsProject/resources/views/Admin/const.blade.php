          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('Admin.index')}}">
                <i class="menu-icon typcn typcn-document-text"></i>
                <span class="menu-title">Mange Admin</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{route('Category.index')}}">
                <i class="menu-icon typcn typcn-document-text"></i>
                <span class="menu-title">Mange Category</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{route('Post.index')}}">
                <i class="menu-icon typcn typcn-document-text"></i>
                <span class="menu-title">Mange Posts</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{route('index')}}">
                <i class="menu-icon typcn typcn-document-text"></i>
                <span class="menu-title">loge out</span>
              </a>
            </li>
